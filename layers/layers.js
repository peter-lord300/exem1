...
var format_turcky_1 = new ol.format.GeoJSON();
var features_turcky_1 = format_turcky_1.readFeatures(json_turcky_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_turcky_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_turcky_1.addFeatures(features_turcky_1);
var lyr_turcky_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_turcky_1, 
                style: style_turcky_1,
                popuplayertitle: 'turcky',
                interactive: true,
                title: '<img src="styles/legend/turcky_1.png" /> turcky'
            });
